#ifndef EASTWOOD_DUNESHPFILE_H
#define EASTWOOD_DUNESHPFILE_H
...
class DuneShpFile : public BaseImageSequence
{
public:
	DuneShpFile(std::istream &stream);
	~DuneShpFile();
...
private:
    ...
    void decodeFrame(std::istream &stream, uint16_t fileIndex);
